<x-layouts.navigation>
    <div x-data="{ openSideContact: true }" class="flex w-full h-full">
        <div x-show="openSideContact"
            ...
            class="flex float-left flex-col gap-2 h-full" class="dark:bg-[#18181B]  bg-[#EDEDED]">
            <div
                ...
                <div class="flex flex-col px-6 py-8 h-full gap-[25px]">
                    <x-finder class="w-full !border-1px !border-[#DADADA]" icon_pos="left" placeholder="Find Messages"/>
        ...
        <div class="flex relative flex-col px-[55px] w-full h-full" id="overview">
            <div
                        ...
                        <a class="p-1 rounded-xl  dark:hover:bg-[#FAFAFA] dark:hover:bg-opacity-10 hover:bg-gray-100"
                            ...
                            <div class="flex gap-[15px] items-center">
                                ...
                                <div class="flex flex-col gap-[1px]">
                                    <span class="font-semibold text-gray-900 dark:text-gray-200" id="channelName">Tim Kocak Abis</span>
                                    <span class="text-[12px] text-[#9F9F9F] font-semibold " id="channelLomba">4C Competition</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="flex gap-[13px]">
                        <div class="w-[36px] h-[36px] p-2 flex items-center justify-center border-[1px] border-[#C2C2C2] rounded-[7px]">
                        ...
                        {{-- <div class="relative" x-data="{ open: false }" @click.outside="open = false"
                            ...
                            div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                class="absolute z-50 mt-2 min-w-[250px] w-auto  ltr:origin-top-right rtl:origin-top-left end-0"
                ...
                <div class="border-[1px] border-[#E7E7E7] p-[11px] rounded-lg flex gap-3 items-center">
                    <div class="rounded-full min-w-[27px] h-[27px] flex justify-center items-center bg-[#5645A126] bg-opacity-15">
                        <x-svg.campaign weight=15 height=15 fill="#2A62E3"/>
                    </div>
                    <p class="text-[11px]">📢 Attention, everyone! 🕑 Quick update: We'll need everyone to continue working until 2:00 PM today. Your dedication is greatly appreciated! If you have any questions or concerns, feel free to ask. Keep your spirits up! 💪</p>
                </div>
            </div>
            ...
            <div
                ...
                <input value="" autocomplete="off"
                    class="py-3 w-full h-full border-none rounded-[10px]"
