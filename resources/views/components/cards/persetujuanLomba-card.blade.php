@props(['title', 'university','status' => "selesai"])
...
<div data-aos="fade" data-aos-duration="1000" class="w-[303px] min-w-[303px] h-fit rounded-lg border border-[#E7E7E7] overflow-hidden">
    ...
    <div class="p-4">
        ...
        <div class="flex gap-2 mt-3">
            @if($status == "belum")
                <button class="px-5 py-2 bg-black text-white text-[12px] rounded-full">Lihat Detail</button>
                <button class="p-2 bg-[#1CED9A] rounded-full">
                ...
                <button class="p-2 bg-transparent border border-[#FF1326] rounded-full">
