...
<div class="swiper-slide w-[730.2296752929688px] flex items-center justify-center gap-x-6 h-[498px] overflow-hidden">
    ...
    <div class="w-1/3 h-[498px]">
        <img class="rounded-xl w-full h-[498px] object-cover" src="{{ $imagePath }}" alt="Testimonial">
    </div>
    <div class="desc bg-gray text-white rounded-lg w-2/3 h-[498px] shadow-lg flex flex-col justify-center p-6">
