    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-5 sm:px-20">
        <div class="flex flex-col lg:justify-center h-full">
            ...
            <div class="flex mt-4 space-x-4">
                <a href="#" class="text-xl text-white"><i class="fab fa-instagram"></i></a>
                <a href="#" class="text-xl text-white"><i class="fas fa-paper-plane"></i></a>
                <a href="#" class="text-xl text-white"><i class="fab fa-whatsapp"></i></a>
            </div>
        </div>
        <div>
            <h2 class="text-lg font-bold">Akademik</h2>
            <ul class="mt-4 sm:space-y-2 text-[#DDDDDD]">
                <li>Fakultas</li>
                <li>E-Learning</li>
                <li>Open Education</li>
                <li>Library</li>
                <li>Jurnal</li>
                <li>Google Scholar Tel-u</li>
            </ul>
        </div>
        <div class="sm:space-y-4">
            <h2 class="text-lg font-bold">Kontak Kami</h2>
            <p class="text-[#DDDDDD]"><i class="fas fa-envelope"></i> dif@jagolomba</p>
            <h2 class="mt-4 text-lg font-bold">Language</h2>
            <ul class="sm:space-y-4 text-[#DDDDDD]">
                <li>Indonesia</li>
                <li>English</li>
            </ul>
        </div>
        ...
        <div class="sm:mt-10 mt-5 text-sm text-[#DDDDDD]">
            2025 &copy; Jago Lomba
        </div>
    </div>
</footer>
